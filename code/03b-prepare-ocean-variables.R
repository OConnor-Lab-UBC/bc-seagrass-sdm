...
#load oceanography data
load(file = "code/output_data/intermediate_ocean_variables/BCCM_data.RData")
load(file = "code/output_data/intermediate_ocean_variables/SSC_year_data.RData")
load(file = "code/output_data/intermediate_ocean_variables/SSC_month_data.RData")
load(file = "code/output_data/intermediate_ocean_variables/NEP36_year_data.RData")
load(file = "code/output_data/intermediate_ocean_variables/NEP36_month_data.RData")
load(file = "code/output_data/intermediate_ocean_variables/CHELSA_month_data.RData")
...
NEP36_PAR_sur_mean_rast <- terra::rasterize(year_surf_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(year_surf_points), res=2000),field = "PAR_mean_sur", fun=mean)
NEP36_PAR_sur_max_rast <- terra::rasterize(year_surf_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(year_surf_points), res=2000),field = "PAR_max_sur", fun=mean)
NEP36_PAR_sur_min_rast <- terra::rasterize(year_surf_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(year_surf_points), res=2000),field = "PAR_min_sur", fun=mean)
NEP36_NH4_sur_mean_rast <- terra::rasterize(year_surf_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(year_surf_points), res=2000),field = "NH4_mean_sur", fun=mean)
NEP36_NO3_sur_mean_rast <- terra::rasterize(year_surf_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(year_surf_points), res=2000),field = "NO3_mean_sur", fun=mean)
NEP36_DO_sur_mean_rast <- terra::rasterize(year_surf_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(year_surf_points), res=2000),field = "DO_mean_sur", fun=mean)
NEP36_DO_sur_min_rast <- terra::rasterize(year_surf_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(year_surf_points), res=2000),field = "DO_min_sur", fun=mean)
...
NEP36_PAR_5_mean_rast <- terra::rasterize(year_5_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(year_5_points), res=2000),field = "PAR_mean_5", fun=mean) %>%
  terra::merge(NEP36_PAR_sur_mean_rast, na.rm=TRUE)
NEP36_PAR_5_max_rast <- terra::rasterize(year_5_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(year_5_points), res=2000),field = "PAR_max_5", fun=mean)%>%
  terra::merge(NEP36_PAR_sur_max_rast, na.rm=TRUE)
NEP36_PAR_5_min_rast <- terra::rasterize(year_5_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(year_5_points), res=2000),field = "PAR_min_5", fun=mean)%>%
  terra::merge(NEP36_PAR_sur_min_rast, na.rm=TRUE)
NEP36_NH4_5_mean_rast <- terra::rasterize(year_5_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(year_5_points), res=2000),field = "NH4_mean_5", fun=mean)%>%
  terra::merge(NEP36_NH4_sur_mean_rast, na.rm=TRUE)
NEP36_NO3_5_mean_rast <- terra::rasterize(year_5_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(year_5_points), res=2000),field = "NO3_mean_5", fun=mean)%>%
  terra::merge(NEP36_NO3_sur_mean_rast, na.rm=TRUE)
NEP36_DO_5_mean_rast <- terra::rasterize(year_5_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(year_5_points), res=2000),field = "DO_mean_5", fun=mean)%>%
...
#Rasterize all  predictors of intrerest onto the 2000m equal area grid with mean = akin to project, merge with surface values because loose very shallow areas
NEP36_temp_sur_mean_rast <- terra::rasterize(month_surf_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(month_surf_points), res=2000),field = "temp_mean_sur", fun=mean)
NEP36_temp_sur_max_rast <- terra::rasterize(month_surf_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(month_surf_points), res=2000),field = "temp_max_sur", fun=mean)
NEP36_temp_sur_min_rast <- terra::rasterize(month_surf_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(month_surf_points), res=2000),field = "temp_min_sur", fun=mean)
NEP36_temp_sur_cv_rast <- terra::rasterize(month_surf_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(month_surf_points), res=2000),field = "temp_cv_sur", fun=mean)
NEP36_temp_sur_diff_rast <- terra::rasterize(month_surf_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(month_surf_points), res=2000),field = "temp_diff_sur", fun=mean)
NEP36_salt_sur_mean_rast <- terra::rasterize(month_surf_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(month_surf_points), res=2000),field = "salt_mean_sur", fun=mean)
NEP36_salt_sur_min_rast <- terra::rasterize(month_surf_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(month_surf_points), res=2000),field = "salt_min_sur", fun=mean)
NEP36_salt_sur_cv_rast <- terra::rasterize(month_surf_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(month_surf_points), res=2000),field = "salt_cv_sur", fun=mean)
...
#Rasterize all  predictors of intrerest onto the 2000m equal area grid with mean = akin to project, merge with surface values because loose very shallow areas
NEP36_temp_5_mean_rast <- terra::rasterize(month_5_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(month_5_points), res=2000),field = "temp_mean_5", fun=mean) %>%
  terra::merge(NEP36_temp_sur_mean_rast, na.rm=TRUE)
NEP36_temp_5_max_rast <- terra::rasterize(month_5_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(month_5_points), res=2000),field = "temp_max_5", fun=mean)%>%
  terra::merge(NEP36_temp_sur_max_rast, na.rm=TRUE)
NEP36_temp_5_min_rast <- terra::rasterize(month_5_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(month_5_points), res=2000),field = "temp_min_5", fun=mean)%>%
  terra::merge(NEP36_temp_sur_min_rast, na.rm=TRUE)
NEP36_temp_5_diff_rast <- terra::rasterize(month_5_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(month_5_points), res=2000),field = "temp_diff_5", fun=mean)%>%
  terra::merge(NEP36_temp_sur_diff_rast, na.rm=TRUE)
NEP36_temp_5_cv_rast <- terra::rasterize(month_5_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(month_5_points), res=2000),field = "temp_cv_5", fun=mean)%>%
  terra::merge(NEP36_temp_sur_cv_rast, na.rm=TRUE)
NEP36_salt_5_mean_rast <- terra::rasterize(month_5_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(month_5_points), res=2000),field = "salt_mean_5", fun=mean)%>%
  terra::merge(NEP36_salt_sur_mean_rast, na.rm=TRUE)
NEP36_salt_5_min_rast <- terra::rasterize(month_5_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(month_5_points), res=2000),field = "salt_min_5", fun=mean)%>%
...
month_surf_summary_year <- Month_surf_sub %>% dplyr::group_by(x, y, year) %>% 
  ...
  mutate(precip_cv_year = precip_sd_year/precip_mean_year*100,
         ...
         rsds_cv_year = rsds_sd_year/rsds_mean_year*100)
...
chelsa_precip_cv_rast <- terra::rasterize(month_surf_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(month_surf_points), res=1000),field = "precip_cv", fun=mean)
chelsa_rsds_mean_rast <- terra::rasterize(month_surf_points, terra::rast(crs ="EPSG:3573", extent = terra::ext(month_surf_points), res=1000),field = "rsds_mean", fun=mean)
...
NEP36_layers <- c(NEP36_NH4_5_mean_rast, NEP36_NO3_5_mean_rast, NEP36_salt_5_mean_rast, NEP36_salt_5_min_rast, NEP36_PAR_5_mean_rast, NEP36_PAR_5_min_rast, 
...
NO3_5_mean_rast_bccm <- terra::merge(SSC_Resampled[[2]], BCCM_Resampled[[2]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
salt_5_mean_rast_bccm <- terra::merge(SSC_Resampled[[3]], BCCM_Resampled[[3]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
salt_5_min_rast_bccm <- terra::merge(SSC_Resampled[[4]], BCCM_Resampled[[4]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
PAR_5_mean_rast_bccm <- terra::merge(SSC_Resampled[[5]], BCCM_Resampled[[5]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
PAR_5_min_rast_bccm <- terra::merge(SSC_Resampled[[6]], BCCM_Resampled[[6]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
PAR_5_max_rast_bccm <- terra::merge(SSC_Resampled[[7]], BCCM_Resampled[[7]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
temp_s_mean_rast_bccm <- terra::merge(SSC_Resampled[[8]], BCCM_Resampled[[8]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
temp_s_max_rast_bccm <- terra::merge(SSC_Resampled[[9]], BCCM_Resampled[[9]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
temp_s_min_rast_bccm <- terra::merge(SSC_Resampled[[10]], BCCM_Resampled[[10]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
temp_5_mean_rast_bccm <- terra::merge(SSC_Resampled[[11]], BCCM_Resampled[[11]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
temp_5_max_rast_bccm <- terra::merge(SSC_Resampled[[12]], BCCM_Resampled[[12]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m) 
temp_5_min_rast_bccm <- terra::merge(SSC_Resampled[[13]], BCCM_Resampled[[13]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
do_5_mean_rast_bccm <- terra::merge(SSC_Resampled[[14]], BCCM_Resampled[[14]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
do_5_min_rast_bccm <- terra::merge(SSC_Resampled[[15]], BCCM_Resampled[[15]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
salt_5_cv_rast_bccm <- terra::merge(SSC_Resampled[[16]], BCCM_Resampled[[16]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
temp_5_cv_rast_bccm <- terra::merge(SSC_Resampled[[17]], BCCM_Resampled[[17]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
temp_5_diff_rast_bccm <- terra::merge(SSC_Resampled[[18]], BCCM_Resampled[[18]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
temp_s_cv_rast_bccm <- terra::merge(SSC_Resampled[[19]], BCCM_Resampled[[19]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
temp_s_diff_rast_bccm <- terra::merge(SSC_Resampled[[20]], BCCM_Resampled[[20]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)

NH4_5_mean_rast_nep36 <- terra::merge(SSC_Resampled[[1]], NEP36_Resampled[[1]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
NO3_5_mean_rast_nep36 <- terra::merge(SSC_Resampled[[2]], NEP36_Resampled[[2]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
salt_5_mean_rast_nep36 <- terra::merge(SSC_Resampled[[3]], NEP36_Resampled[[3]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
salt_5_min_rast_nep36 <- terra::merge(SSC_Resampled[[4]], NEP36_Resampled[[4]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
PAR_5_mean_rast_nep36 <- terra::merge(SSC_Resampled[[5]], NEP36_Resampled[[5]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
PAR_5_min_rast_nep36 <- terra::merge(SSC_Resampled[[6]], NEP36_Resampled[[6]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
PAR_5_max_rast_nep36 <- terra::merge(SSC_Resampled[[7]], NEP36_Resampled[[7]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
temp_s_mean_rast_nep36 <- terra::merge(SSC_Resampled[[8]], NEP36_Resampled[[8]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
temp_s_max_rast_nep36 <- terra::merge(SSC_Resampled[[9]], NEP36_Resampled[[9]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
temp_s_min_rast_nep36 <- terra::merge(SSC_Resampled[[10]], NEP36_Resampled[[10]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
temp_5_mean_rast_nep36 <- terra::merge(SSC_Resampled[[11]], NEP36_Resampled[[11]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
temp_5_max_rast_nep36 <- terra::merge(SSC_Resampled[[12]], NEP36_Resampled[[12]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m) 
temp_5_min_rast_nep36 <- terra::merge(SSC_Resampled[[13]], NEP36_Resampled[[13]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
do_5_mean_rast_nep36 <- terra::merge(SSC_Resampled[[14]], NEP36_Resampled[[14]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
do_5_min_rast_nep36 <- terra::merge(SSC_Resampled[[15]], NEP36_Resampled[[15]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
salt_5_cv_rast_nep36 <- terra::merge(SSC_Resampled[[16]], NEP36_Resampled[[16]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
temp_5_cv_rast_nep36 <- terra::merge(SSC_Resampled[[17]], NEP36_Resampled[[17]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
temp_5_diff_rast_nep36 <- terra::merge(SSC_Resampled[[18]], NEP36_Resampled[[18]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
temp_s_cv_rast_nep36 <- terra::merge(SSC_Resampled[[19]], NEP36_Resampled[[19]], na.rm=TRUE) %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
...
precip_min_rast <- CHELSA_Resampled[[7]]  %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
precip_cv_rast <-CHELSA_Resampled[[8]]  %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
rsds_mean_rast <- CHELSA_Resampled[[9]]  %>% terra::mask(bathy20m) %>% terra::crop(bathy20m)
...
Predictor_Hindcast_Climatologies <- c(NH4_5_mean_rast_bccm, NO3_5_mean_rast_bccm, salt_5_mean_rast_bccm, salt_5_min_rast_bccm, PAR_5_mean_rast_bccm, PAR_5_min_rast_bccm, 
                                      PAR_5_max_rast_bccm, temp_s_mean_rast_bccm, temp_s_max_rast_bccm, temp_s_min_rast_bccm, temp_5_mean_rast_bccm, temp_5_max_rast_bccm, 
                                      temp_5_min_rast_bccm, do_5_mean_rast_bccm, do_5_min_rast_bccm, salt_5_cv_rast_bccm, temp_5_cv_rast_bccm, temp_5_diff_rast_bccm, 
                                      temp_s_cv_rast_bccm, temp_s_diff_rast_bccm,
                                      NH4_5_mean_rast_nep36, NO3_5_mean_rast_nep36, salt_5_mean_rast_nep36, salt_5_min_rast_nep36, PAR_5_mean_rast_nep36, PAR_5_min_rast_nep36, 
...
names(Predictor_Hindcast_Climatologies) <- c("NH4_5m_mean_bccm", "NO3_5m_mean_bccm", "salt_5m_mean_bccm", "salt_5m_min_bccm", "PAR_5m_mean_bccm", "PAR_5m_min_bccm", 
                                             ...
                                             "temp_5m_min_bccm", "do_5m_mean_bccm", "do_5m_min_bccm", "salt_5m_cv_bccm", "temp_5m_cv_bccm", "temp_5m_diff_bccm", "temp_s_cv_bccm", "temp_s_diff_bccm",
