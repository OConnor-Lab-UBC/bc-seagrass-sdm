...
WHERE H.LatDegStart IS NOT NULL AND H.LongDegStart IS NOT NULL AND D.ChartDepth IS NOT NULL AND H.Year > 1999 AND H.Species = '6BC' AND H.TransOrientation != 'U' 
