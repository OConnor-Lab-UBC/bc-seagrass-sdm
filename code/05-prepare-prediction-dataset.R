...
env_20m_hg <- env_20m_hg %>% filter(depth < max_depth)
...
env_20m_ncc <- env_20m_ncc %>% filter(depth < max_depth)
...
env_20m_qcs <- env_20m_qcs %>% filter(depth < max_depth)
...
env_20m_wcvi <- env_20m_wcvi %>% filter(depth < max_depth)
...
env_20m_ss <- env_20m_ss %>% filter(depth < max_depth)
